...
from database_setup2 import Category, Base, Category_item, Category_item, User
...
# add a dummy user in the table
user1 = User(name="Ahmad", email="ahmad@abc-123.com", picture="mypic.jpg")
session.add(user1)
session.commit()
